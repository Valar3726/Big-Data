...
public class KMeans extends Configured implements Tool
{
    ...
    public static boolean stopIteration(Configuration conf) throws IOException //called in main
    {
        ...
        Path pervCenterFile=new Path("input/initK.csv");
        Path currentCenterFile=new Path("output2.3/newCentroid/part-r-00000");
	...
	public static class UpdateCenterReducer extends Reducer<Text, Text, Text, Text>
    {
        ...
        public void reduce(Text key,Iterable<Text> values,Context context) throws IOException,InterruptedException
        {
			...
			if(newCenterPoint.arr[0]-Double.parseDouble(str[0])<=THRESHOLD && newCenterPoint.arr[1]-Double.parseDouble(str[1])<=THRESHOLD)
            {
                NoChangeCount++;
			}
			if(NoChangeCount==10)
    ...
    public int run(String[] args) throws Exception
    {
        ...
        FileInputFormat.setInputPaths(job, "input/kmeans.csv");
        Path outDir=new Path("output2.3/newCentroid");
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        Path dataFile=new Path("input/initK.csv");
        ...
        FileInputFormat.setInputPaths(job, "input/kmeans.csv");
        Path outDir=new Path("output2.3/final");
        fs.delete(outDir,true);
        FileOutputFormat.setOutputPath(job, outDir);
